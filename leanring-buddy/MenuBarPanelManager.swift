...
final class MenuBarPanelManager: NSObject {
    ...
    private func createStatusItem() {
        ...
        if let logoBarImage = NSImage(named: "logo-bar") {
            // Resize to standard menu bar icon height (18pt) while preserving aspect ratio.
    ...
    /// Draws the Sensei "S" lettermark as a menu bar icon.
    /// Rendered as a template image so macOS automatically adapts it
    /// to light/dark menu bar appearances.
    private func makeSenseiMenuBarIcon() -> NSImage {
